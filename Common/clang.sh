...
git clone "https://Carlotta-Montelli:$GH_TOKEN@github.com/Carlotta-Montelli/carlotta-clang-19" rel_repo
pushd rel_repo || exit
rm -fr ./*
cp -r ../install/* .
git lfs install
git lfs track "clang-19"
git lfs track "opt"
...
git lfs track "lld"
git lfs track "libclang.so.19.1.7"
git lfs track "libclang-cpp.so.19.1"
...
Builder commit: https://github.com/Carlotta-Montelli/carlotta-clang-19/commit/$builder_commit"
git push
popd || exit
